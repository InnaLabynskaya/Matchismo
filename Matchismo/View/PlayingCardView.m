...
#define PIP_VHOFFSET1_PERCENTAGE 0.090
#define PIP_VHOFFSET2_PERCENTAGE 0.175
#define PIP_VHOFFSET3_PERCENTAGE 0.270
...
- (void)drawPips
{
    ...
    if((self.rank == 2) || (self.rank == 3) || (self.rank == 7) || (self.rank == 8) || (self.rank == 10)) {
        [self drawPipsWithHorizontalOffset:0
                            verticalOffset:PIP_VHOFFSET2_PERCENTAGE
                        mirroredVertically:(self.rank != 7)];
    }
    if((self.rank == 4) || (self.rank == 5) || (self.rank == 6) || (self.rank == 7) || (self.rank == 8) || (self.rank == 9) || (self.rank == 10)) {
        [self drawPipsWithHorizontalOffset:PIP_HOFFSET_PERCENTAGE
                            verticalOffset:PIP_VHOFFSET3_PERCENTAGE
                        mirroredVertically:YES];
    }
    if((self.rank == 9) || (self.rank == 10)) {
        [self drawPipsWithHorizontalOffset:PIP_HOFFSET_PERCENTAGE
                            verticalOffset:PIP_VHOFFSET1_PERCENTAGE
                        mirroredVertically:YES];
    }
}
                          ...
                          upsideDown:(BOOL)upsideDown
{
    ...
    CGPoint pipOrigin = CGPointMake(
                                    ...
                                    middle.x-pipSize.height/2.0-voffset*self.bounds.size.height
                                    );
